...
%     load(str);
%     data_CRL_epi(idxc,:)=feats_epi;
%     data_CRL_stroma(idxc,:)=feats_stroma;
%     idxc=idxc+1;
% end
% data_epi=cat(2,data_epi,data_CRL_epi);
% data_stroma=cat(2,data_stroma,data_CRL_stroma);
% 
...
% save('OralCavity_CRLFeatures_nonan_train50.mat','feature_list_nonan','data_nonan','feature_list_epistroma','data_epistroma','labels');
%% pre select the feature below
% clear all
%% load pre computed feature sets from epi/stroma/whole
load OralCavity_CRLFeatures_nonan_train50.mat
...
% load CRL_wilcoxon_BaggedC45.mat
