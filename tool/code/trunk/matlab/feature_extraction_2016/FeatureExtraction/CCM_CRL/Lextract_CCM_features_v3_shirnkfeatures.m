...
function [feats,feats_description,CGinfo] = Lextract_CCM_features_v3(bounds,I,properties,para)
...
%         curpara.alpha,curpara.radius);
    [feat,feat_description,CGinfo{f}] = Lextract_CCM_features_single_correct_v3(bounds,I,properties,...
        curpara.alpha,curpara.radius);
%     CGinfo{f}=CGinfotemp;
