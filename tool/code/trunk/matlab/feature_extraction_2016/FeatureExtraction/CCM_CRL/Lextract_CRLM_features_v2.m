...
function [feats,feats_description,CGinfo] = Lextract_CRLM_features_v2(bounds,I,properties,para)
...
for f=1:length(set_alpha)
    ...
    [feat,feat_description,CGinfo{f}] = Lextract_CRLM_features_single(bounds,I,properties,...
        curpara.alpha,curpara.radius);
    %     CGinfo{f}=CGinfotemp;
