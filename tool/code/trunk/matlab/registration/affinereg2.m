function [Iregd,rigidparams,varargout] = affinereg2(Itemplate,Itarget,N,varargin)
...
rigidparams=fminsearch(@objdef2d, startparams_objdef, optoptions,...
...
if ~ip.Results.nodisp,
    ...
    figure; imdisp(overlayims(:,:,1));
    figure; imdisp(checkerims(:,:,1));
end
