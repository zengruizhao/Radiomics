...
cmd:option('-maxepochs',30,'max number of epochs of train and test loop')
...
-- training:
cmd:option('-save', 'prueba-cuda', 'subdirectory to save/log experiments in')
...
dofile '1_data_images_train.lua'
