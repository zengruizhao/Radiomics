...
function test()
   ...
   for f = 1,#test_predict do
	--print(test_prob[f])
      predictOutFile:write(testData.files[f] .. "\t" .. testData.centroids[f][1] .. "\t" .. testData.centroids[f][2] .. "\t" .. string.format('%d',test_predict[f]) ..  "\t" .. test_output[f][1] .. "\t" .. test_output[f][2] .."\t" .. test_prob1[f] .. "\t" .. test_prob2[f] .. "\n")
   end
