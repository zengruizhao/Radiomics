...
--	end	
   ...
   print(confusion)
	...
	if tesize~=nil then
		...
		filenameout="learnedfeatures_train_" .. opt.dataset .."_CNN_per" .. opt.dsperc .. "_imtr" .. trsize .. "_epoch" .. (epoch)  .. ".txt"	
	end
   ...
   if tesize~=nil then
	...
	filenameout="predictions_train_" .. opt.dataset .."_CNN_per" .. opt.dsperc .. "_imtr" .. trsize ..  "_epoch" .. (epoch)  .. ".txt"
   end
