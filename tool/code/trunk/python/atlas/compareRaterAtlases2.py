...
paths = ["C:\\Mirabela\\Projects\\AtlasComparison\\Results\\Comparisons\\33_old",
         "C:\\Mirabela\\Projects\\AtlasComparison\\Results\\Comparisons\\33",
         "C:\\Mirabela\\Projects\\AtlasComparison\\Results\\Comparisons\\33_D",
         "C:\\Mirabela\\Projects\\AtlasComparison\\Results\\Comparisons\\33_N"]

         
prfx_l = ["Dis3_vs_Nor3_atlas_","Dis3_vs_Nor3_atlas_","Dis3_vs_Dis3_atlas_","Nor3_vs_Nor3_atlas_"]
atls = "UH_UC_SV"
regn_l = ["CG","Prostate"]
...
for prfx_idx, prfx in enumerate(prfx_l):
    for regn_idx, regn in enumerate(regn_l):
        ...
        r1_exp_path_in = os.path.join(paths[prfx_idx],prfx+'1_label_'+regn+".mha")
        r2_exp_path_in = os.path.join(paths[prfx_idx],prfx+'2_label_'+regn+".mha")
        ...
        print "Edge Voxels", max(np.sum(r1_grad_arr>0),np.sum(r2_grad_arr>0))
