...
#include "ccipdCalculateDICE.h" // for dice calculation
...
int main( int argc, char *argv[] )
{
  ...
  const auto dice = ccipd::CalculateDice(
    mask1, mask2, smoothingVariance, increaseSizeInMM );
  cout << endl << "Dice = " << dice << endl << endl;
