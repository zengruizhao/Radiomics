 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickDifferenceEntropyFilter_hxx
#define __itkHaralickDifferenceEntropyFilter_hxx
...
HaralickDifferenceEntropyFilter< TInputImage, TOutputImage >
...
::ThreadedGenerateData(const OutputImageRegionType & outputRegionForThread, ThreadIdType threadId)
{
  ...
  // Retrieve Output
  typename OutputImageType::Pointer pDifferenceEntropyOutputFeatureImage    = this->GetOutput(0);
  ...
  ImageRegionIterator<OutputImageType>  differenceEntropyIt;
...
void 
HaralickDifferenceEntropyFilter<TInputImageType, TOutputImageType>
...
#endif // __itkHaralickDifferenceEntropyFilter_hxx
