 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickSumEntropyFilter_hxx
#define __itkHaralickSumEntropyFilter_hxx
...
HaralickSumEntropyFilter< TInputImage, TOutputImage >
...
::ThreadedGenerateData(const OutputImageRegionType & outputRegionForThread, ThreadIdType threadId)
{
  ...
  // Retrieve Output
  typename OutputImageType::Pointer pSumEntropyOutputFeatureImage           = this->GetOutput(0);
  ...
  ImageRegionIterator<OutputImageType>  sumEntropyIt;
...
void 
HaralickSumEntropyFilter<TInputImageType, TOutputImageType>
...
#endif // __itkHaralickSumEntropyFilter_hxx
