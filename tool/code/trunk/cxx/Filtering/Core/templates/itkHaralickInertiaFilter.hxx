 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickInertiaFilter_hxx
#define __itkHaralickInertiaFilter_hxx
...
HaralickInertiaFilter< TInputImage, TOutputImage >
...
::ThreadedGenerateData(const OutputImageRegionType & outputRegionForThread, ThreadIdType threadId)
{
  ...
  // Retrieve Output
  typename OutputImageType::Pointer pInertiaOutputFeatureImage              = this->GetOutput(0); 
  ...
  ImageRegionIterator<OutputImageType> inertiaIt;
...
void 
HaralickInertiaFilter<TInputImageType, TOutputImageType>
...
#endif // __itkHaralickInertiaFilter_hxx
