 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickVarianceFilter_hxx
#define __itkHaralickVarianceFilter_hxx
...
HaralickVarianceFilter< TInputImage, TOutputImage >
...
::ThreadedGenerateData(const OutputImageRegionType & outputRegionForThread, ThreadIdType threadId)
{
  ...
  // Retrieve Output
  typename OutputImageType::Pointer pVarianceOutputFeatureImage           = this->GetOutput(0);
  ...
  ImageRegionIterator<OutputImageType>  varianceIt;
...
void 
HaralickVarianceFilter<TInputImageType, TOutputImageType>
...
#endif // __itkHaralickVarianceFilter_hxx
