 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickIMC1Filter_hxx
#define __itkHaralickIMC1Filter_hxx
...
HaralickIMC1Filter< TInputImage, TOutputImage >
::HaralickIMC1Filter()
{
...
::ThreadedGenerateData(const OutputImageRegionType & outputRegionForThread, ThreadIdType threadId)
{
  ...
  // Retrieve Output
  typename OutputImageType::Pointer pIMC1OutputFeatureImage                 = this->GetOutput(0);
  ...
  ImageRegionIterator<OutputImageType>  iMC1It  ;
...
void 
HaralickIMC1Filter<TInputImageType, TOutputImageType>
...
#endif // __itkHaralickIMC1Filter_hxx
