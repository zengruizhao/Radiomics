 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickClusterShadeFilter_hxx
#define __itkHaralickClusterShadeFilter_hxx
...
HaralickClusterShadeFilter< TInputImage, TOutputImage >
...
::ThreadedGenerateData(const OutputImageRegionType & outputRegionForThread, ThreadIdType threadId)
{
  ...
  // Retrieve Output
  typename OutputImageType::Pointer pClusterShadeFeatureOutputImage               = this->GetOutput(0);
  ...
  ImageRegionIterator<OutputImageType>  clusterShadeIt;
  ...
  for ( faceListIt = faceList.begin(); faceListIt != faceList.end(); ++faceListIt )
  {
    ...
    clusterShadeIt                 = ImageRegionIterator< OutputImageType >(pClusterShadeFeatureOutputImage             , *faceListIt);
...
void 
HaralickClusterShadeFilter<TInputImageType, TOutputImageType>
...
#endif // __itkHaralickClusterShadeFilter_hxx
