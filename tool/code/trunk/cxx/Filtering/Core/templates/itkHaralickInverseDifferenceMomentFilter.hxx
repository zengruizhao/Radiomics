 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickInverseDifferenceMomentFilter_hxx
#define __itkHaralickInverseDifferenceMomentFilter_hxx
...
HaralickInverseDifferenceMomentFilter< TInputImage, TOutputImage >
...
::ThreadedGenerateData(const OutputImageRegionType & outputRegionForThread, ThreadIdType threadId)
{
  ...
  // Retrieve Output
  typename OutputImageType::Pointer pInverseDifferenceMomentFeatureOutputImage               = this->GetOutput(0);
  ...
  ImageRegionIterator<OutputImageType>  inverseDifferenceMomentIt;
  ...
  for ( faceListIt = faceList.begin(); faceListIt != faceList.end(); ++faceListIt )
  {
    ...
    inverseDifferenceMomentIt                 = ImageRegionIterator< OutputImageType >(pInverseDifferenceMomentFeatureOutputImage             , *faceListIt);
...
/////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  if(m_Offset[0] == 0 && m_Offset[1] == 0 && m_Offset[0] == 0) 
	  {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      // Compute textures indices
	   ...
	   // Fill outputs
      inverseDifferenceMomentIt              .Set(static_cast< OutputImagePixelType >(m_featureCalculator->GetInverseDifferenceMoment()));
     

      ++inputIt               ;
      ++inverseDifferenceMomentIt              ;
...
void 
HaralickInverseDifferenceMomentFilter<TInputImageType, TOutputImageType>
...
#endif // __itkHaralickInverseDifferenceMomentFilter_hxx
