 ...
 *
 *=========================================================================*/
#ifndef __itkCorrelationFilter_hxx
#define __itkCorrelationFilter_hxx
...
CorrelationFilter< TInputImage, TOutputImage >
::CorrelationFilter()
{
...
::ThreadedGenerateData(const OutputImageRegionType & outputRegionForThread, ThreadIdType threadId)
{
  ...
  // Retrieve Output
  typename OutputImageType::Pointer pCorrelationOutputFeatureImage          = this->GetOutput(0); 
  ...
  ImageRegionIterator<OutputImageType>  correlationIt;
...
void 
CorrelationFilter<TInputImageType, TOutputImageType>
...
#endif // __itkCorrelationFilter_hxx
