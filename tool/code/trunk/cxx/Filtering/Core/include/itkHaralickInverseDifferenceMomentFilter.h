 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickInverseDifferenceMomentFilter_h
#define __itkHaralickInverseDifferenceMomentFilter_h
...
namespace itk
{
  ...
  /** \class HaralickInverseDifferenceMomentFilter
...
class ITK_EXPORT HaralickInverseDifferenceMomentFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
...
// TODO: GET ALL THE REQUESTED FEATURES AS A VECTOR image
  ...
  typedef HaralickInverseDifferenceMomentFilter                                    Self;
  ...
  itkTypeMacro(HaralickInverseDifferenceMomentFilter, BoxImageFilter);
...
protected:
  HaralickInverseDifferenceMomentFilter();
  virtual ~HaralickInverseDifferenceMomentFilter() {}

  /** HaralickInverseDifferenceMomentFilter can be implemented as a multithreaded filter.
   ...
   *
   * \sa HaralickInverseDifferenceMomentFilter::ThreadedGenerateData()
   */
...
private:
  HaralickInverseDifferenceMomentFilter(const Self &); //purposely not implemented
...
#include "itkHaralickInverseDifferenceMomentFilter.hxx"
#endif

#endif // __itkHaralickInverseDifferenceMomentFilter_h
