 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickDifferenceEntropyFilter_h
#define __itkHaralickDifferenceEntropyFilter_h
...
namespace itk
{
  ...
  /** \class HaralickDifferenceEntropyFilter
 * \brief class for HaralickDifferenceEntropyFiltering Texture Features Extraction,
...
class ITK_EXPORT HaralickDifferenceEntropyFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
...
//   itkGetMacro(Radius, InputImageRegionSizeType);
  ...
  typedef HaralickDifferenceEntropyFilter                                 Self;
  ...
  itkTypeMacro(HaralickDifferenceEntropyFilter, BoxImageFilter);
...
protected:
  HaralickDifferenceEntropyFilter();
  virtual ~HaralickDifferenceEntropyFilter() {}

  /** HaralickDifferenceEntropyFilter can be implemented as a multithreaded filter.
   ...
   *
   * \sa HaralickDifferenceEntropyFilter::ThreadedGenerateData()
   */
...
private:
  HaralickDifferenceEntropyFilter(const Self &); //purposely not implemented
...
#include "itkHaralickDifferenceEntropyFilter.hxx"
#endif

#endif // __itkHaralickDifferenceEntropyFilter_h
