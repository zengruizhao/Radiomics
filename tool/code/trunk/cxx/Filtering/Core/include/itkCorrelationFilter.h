 ...
 *
 *=========================================================================*/
#ifndef __itkCorrelationFilter_h
#define __itkCorrelationFilter_h
 ...
 * \brief class for CorrelationFiltering Texture Features Extraction,
...
class ITK_EXPORT CorrelationFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
...
//   itkGetMacro(Radius, InputImageRegionSizeType);
  ...
  typedef CorrelationFilter                                 Self;
  ...
  itkTypeMacro(CorrelationFilter, BoxImageFilter);
...
protected:
  ...
  /** CorrelationFilter can be implemented as a multithreaded filter.
   ...
   *
   * \sa CorrelationFilter::ThreadedGenerateData()
   */
...
private:
  CorrelationFilter(const Self &); //purposely not implemented
...
#include "itkCorrelationFilter.hxx"
#endif

#endif // __itkCorrelationFilter_h
