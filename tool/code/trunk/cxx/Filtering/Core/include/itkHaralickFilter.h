 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickFilter_h
#define __itkHaralickFilter_h
...
namespace itk
{
  ...
  /** \class HaralickFilter
 * \brief class for Haralick Texture Features Extraction,
...
class ITK_EXPORT HaralickFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
...
//   itkGetMacro(Radius, InputImageRegionSizeType);
  ...
  OutputImagePointerType GetEnergyOutput();
  OutputImagePointerType GetEntropyOutput();
  OutputImagePointerType GetCorrelationOutput();
  OutputImagePointerType GetInverseDifferenceMomentOutput();
  OutputImagePointerType GetInertiaOutput();
  OutputImagePointerType GetClusterShadeOutput();
  OutputImagePointerType GetClusterProminenceOutput();
  OutputImagePointerType GetHaralickCorrelationOutput();
  OutputImagePointerType GetMeanOutput();
  OutputImagePointerType GetVarianceOutput();
  OutputImagePointerType GetSumAverageOutput();
  OutputImagePointerType GetSumVarianceOutput();
  OutputImagePointerType GetSumEntropyOutput();
  OutputImagePointerType GetDifferenceEntropyOutput();
  OutputImagePointerType GetDifferenceVarianceOutput();
  OutputImagePointerType GetIMC1Output();
  OutputImagePointerType GetIMC2Output();


// TODO: Support more than one offset
// TODO: Support different types of boundary conditions for dealing with the borders
// TODO: define all the iterators as private members to save memory and increase speed
// TODO: Use enumerator for Features instead of numbers
// TODO: Support only calculating only a subset of requested features
// TODO: GET ALL THE REQUESTED FEATURES AS A VECTOR image

  /** Standard class typedefs. */
  typedef HaralickFilter                                    Self;
  ...
  itkTypeMacro(HaralickFilter, BoxImageFilter);
...
protected:
  HaralickFilter();
  virtual ~HaralickFilter() {}

  /** HaralickFilter can be implemented as a multithreaded filter.
   ...
   *
   * \sa HaralickFilter::ThreadedGenerateData()
   */
...
private:
  HaralickFilter(const Self &); //purposely not implemented
...
//      bool m_bFeaturesCalculated;
};
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkHaralickFilter.hxx"
#endif

#endif // __itkHaralickFilter_h
