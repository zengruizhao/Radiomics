 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickClusterShadeFilter_h
#define __itkHaralickClusterShadeFilter_h
...
namespace itk
{
  ...
  /** \class HaralickClusterShadeFilter
...
class ITK_EXPORT HaralickClusterShadeFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
...
// TODO: GET ALL THE REQUESTED FEATURES AS A VECTOR image
  ...
  typedef HaralickClusterShadeFilter                                    Self;
  ...
  itkTypeMacro(HaralickClusterShadeFilter, BoxImageFilter);
...
protected:
  HaralickClusterShadeFilter();
  virtual ~HaralickClusterShadeFilter() {}

  /** HaralickClusterShadeFilter can be implemented as a multithreaded filter.
   ...
   *
   * \sa HaralickClusterShadeFilter::ThreadedGenerateData()
   */
...
private:
  HaralickClusterShadeFilter(const Self &); //purposely not implemented
...
#include "itkHaralickClusterShadeFilter.hxx"
#endif

#endif // __itkHaralickClusterShadeFilter_h
