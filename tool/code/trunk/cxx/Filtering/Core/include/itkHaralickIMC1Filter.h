 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickIMC1Filter_h
#define __itkHaralickIMC1Filter_h
...
namespace itk
{
  ...
  /** \class HaralickIMC1Filter
 * \brief class for HaralickIMC1Filtering Texture Features Extraction,
...
class ITK_EXPORT HaralickIMC1Filter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
...
//   itkGetMacro(Radius, InputImageRegionSizeType);
  ...
  typedef HaralickIMC1Filter                                 Self;
  ...
  itkTypeMacro(HaralickIMC1Filter, BoxImageFilter);
...
protected:
  HaralickIMC1Filter();
  virtual ~HaralickIMC1Filter() {}

  /** HaralickIMC1Filter can be implemented as a multithreaded filter.
   ...
   *
   * \sa HaralickIMC1Filter::ThreadedGenerateData()
   */
...
private:
  HaralickIMC1Filter(const Self &); //purposely not implemented
...
#include "itkHaralickIMC1Filter.hxx"
#endif

#endif // __itkHaralickIMC1Filter_h
