 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickEnergyFilter_h
#define __itkHaralickEnergyFilter_h
...
class ITK_EXPORT HaralickEnergyFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
...
// TODO: GET ALL THE REQUESTED FEATURES AS A VECTOR image
  ...
  typedef HaralickEnergyFilter                                    Self;
  ...
  itkTypeMacro(HaralickEnergyFilter, BoxImageFilter);
...
protected:
  HaralickEnergyFilter();
  virtual ~HaralickEnergyFilter() {}

  /** HaralickEnergyFilter can be implemented as a multithreaded filter.
   ...
   *
   * \sa HaralickEnergyFilter::ThreadedGenerateData()
   */
...
private:
  HaralickEnergyFilter(const Self &); //purposely not implemented
...
#include "itkHaralickEnergyFilter.hxx"
#endif

#endif // __itkHaralickEnergyFilter_h
