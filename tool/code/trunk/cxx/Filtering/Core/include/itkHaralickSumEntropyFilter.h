 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickSumEntropyFilter_h
#define __itkHaralickSumEntropyFilter_h
...
namespace itk
{
  ...
  /** \class HaralickSumEntropyFilter
 * \brief class for HaralickSumEntropyFiltering Texture Features Extraction,
...
class ITK_EXPORT HaralickSumEntropyFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
...
//   itkGetMacro(Radius, InputImageRegionSizeType);
  ...
  typedef HaralickSumEntropyFilter                                 Self;
  ...
  itkTypeMacro(HaralickSumEntropyFilter, BoxImageFilter);
...
protected:
  HaralickSumEntropyFilter();
  virtual ~HaralickSumEntropyFilter() {}

  /** HaralickSumEntropyFilter can be implemented as a multithreaded filter.
   ...
   *
   * \sa HaralickSumEntropyFilter::ThreadedGenerateData()
   */
...
private:
  HaralickSumEntropyFilter(const Self &); //purposely not implemented
...
#include "itkHaralickSumEntropyFilter.hxx"
#endif

#endif // __itkHaralickSumEntropyFilter_h
