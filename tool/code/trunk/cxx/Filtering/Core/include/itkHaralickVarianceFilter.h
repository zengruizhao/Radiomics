 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickVarianceFilter_h
#define __itkHaralickVarianceFilter_h
...
namespace itk
{
  ...
  /** \class HaralickVarianceFilter
 * \brief class for HaralickVarianceFiltering Texture Features Extraction,
...
class ITK_EXPORT HaralickVarianceFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
...
//   itkGetMacro(Radius, InputImageRegionSizeType);
  ...
  typedef HaralickVarianceFilter                                 Self;
  ...
  itkTypeMacro(HaralickVarianceFilter, BoxImageFilter);
...
protected:
  HaralickVarianceFilter();
  virtual ~HaralickVarianceFilter() {}

  /** HaralickVarianceFilter can be implemented as a multithreaded filter.
   ...
   *
   * \sa HaralickVarianceFilter::ThreadedGenerateData()
   */
...
private:
  HaralickVarianceFilter(const Self &); //purposely not implemented
...
#include "itkHaralickVarianceFilter.hxx"
#endif

#endif // __itkHaralickVarianceFilter_h
