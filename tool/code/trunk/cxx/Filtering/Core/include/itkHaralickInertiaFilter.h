 ...
 *
 *=========================================================================*/
#ifndef __itkHaralickInertiaFilter_h
#define __itkHaralickInertiaFilter_h
...
namespace itk
{
  ...
  /** \class HaralickInertiaFilter
 * \brief class for HaralickInertiaFiltering Texture Features Extraction,
...
class ITK_EXPORT HaralickInertiaFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
...
//   itkGetMacro(Radius, InputImageRegionSizeType);
  ...
  typedef HaralickInertiaFilter                                 Self;
  ...
  itkTypeMacro(HaralickInertiaFilter, BoxImageFilter);
...
protected:
  HaralickInertiaFilter();
  virtual ~HaralickInertiaFilter() {}

  /** HaralickInertiaFilter can be implemented as a multithreaded filter.
   ...
   *
   * \sa HaralickInertiaFilter::ThreadedGenerateData()
   */
...
private:
  HaralickInertiaFilter(const Self &); //purposely not implemented
...
#include "itkHaralickInertiaFilter.hxx"
#endif

#endif // __itkHaralickInertiaFilter_h
