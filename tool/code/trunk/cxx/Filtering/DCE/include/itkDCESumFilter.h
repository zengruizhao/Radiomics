#ifndef __itkDCESumFilter_h
#define __itkDCESumFilter_h
...
class DCESumFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
  ...
  itkTypeMacro(DCESumFilter, BoxImageFilter);
...
private:
  DCESumFilter(const Self &); //purposely not implemented
