#ifndef __itkDCEMeanFilter_h
#define __itkDCEMeanFilter_h
...
class DCEMeanFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
  ...
  itkTypeMacro(DCEMeanFilter, BoxImageFilter);
...
private:
  DCEMeanFilter(const Self &); //purposely not implemented
