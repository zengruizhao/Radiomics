#ifndef __itkDCEStdDevFilter_h
#define __itkDCEStdDevFilter_h
...
class DCEStdDevFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
  ...
  itkTypeMacro(DCEStdDevFilter, BoxImageFilter);
...
private:
  DCEStdDevFilter(const Self &); //purposely not implemented
  ...
  const static unsigned int   m_NumberOfSupportedDCEFeatures = 1; // has to be modified when adding new DCE Features
	...
	#include "itkDCEStdDevFilter.hxx"
#endif
