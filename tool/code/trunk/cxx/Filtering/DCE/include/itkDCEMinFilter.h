#ifndef __itkDCEMinFilter_h
#define __itkDCEMinFilter_h
...
class DCEMinFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
  ...
  itkTypeMacro(DCEMinFilter, BoxImageFilter);
...
private:
  DCEMinFilter(const Self &); //purposely not implemented
