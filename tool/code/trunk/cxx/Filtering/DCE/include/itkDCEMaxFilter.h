#ifndef __itkDCEMaxFilter_h
#define __itkDCEMaxFilter_h
...
class DCEMaxFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
  ...
  itkTypeMacro(DCEMaxFilter, BoxImageFilter);
...
private:
  DCEMaxFilter(const Self &); //purposely not implemented
