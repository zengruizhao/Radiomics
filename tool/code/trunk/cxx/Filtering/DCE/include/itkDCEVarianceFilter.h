#ifndef __itkDCEVarianceFilter_h
#define __itkDCEVarianceFilter_h
...
class DCEVarianceFilter: public BoxImageFilter< TInputImage, TOutputImage >
{
public:
  ...
  typedef DCEVarianceFilter                                          Self        ;
  ...
  itkTypeMacro(DCEVarianceFilter, BoxImageFilter);
...
private:
  DCEVarianceFilter(const Self &); //purposely not implemented
  ...
  const static unsigned int   m_NumberOfSupportedDCEFeatures = 1; // has to be modified when adding new DCE Features
	...
	#include "itkDCEVarianceFilter.hxx"
#endif
